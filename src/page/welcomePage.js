...
export default function welcomePage() {
 ...
 <div className="container">
  ...
  Welcome!
      ...
      <p className="card-text fs-6"  style={{color:'white' , fontFamily:" 'Cabin',''", fontSize: "20px", marginTop:'30px'}}>Experience holistic healing with our expert Ayurveda services, dedicated to your well-being and comfort.</p>
      <button type="button" className="btn" style={{ backgroundColor: '#24757e', color: 'white', marginTop:'50px' , width:"100px" }}>LOG IN</button>
